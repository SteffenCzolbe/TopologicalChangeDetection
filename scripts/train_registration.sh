...
$WRAPPER_FUNC python -m src.train_registration --dataset brain2d --channels 64 128 256 --fixed_model_var --trainable_prior --prior_weights_init 4 4 --recon_weight_init -5 --trainable_recon --trainable_recon_var --gpus -1 --accelerator dp --max_epochs 600 --lr_decline_patience 500 --early_stop_patience 800 --batch_size 32 --bnorm --dropout --notest --fast_dev_run=$FAST_DEV_RUN
