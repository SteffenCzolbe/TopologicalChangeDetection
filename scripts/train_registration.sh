...
$WRAPPER_FUNC python -m src.train_registration --dataset brain2d --channels 64 128 256 --batch_size 32 --gpus -1 --accelerator dp --max_epochs 80 --lr_decline_patience 10 --early_stop_patience 25 --conv_layers_per_stage 1 --bnorm --dropout --notest
