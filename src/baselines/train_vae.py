...
def build_arg_parser():
    ...
    parser = VAEAnaomalyDetection.add_model_specific_args(parser)
...
def load_datamodule_from_params(hparams):
    datamodule = util.load_datamodule_from_name(
        hparams.dataset, batch_size=hparams.batch_size, pairs=False)
